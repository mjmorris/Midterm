...
public abstract class Person {
	...
	public int PrintAge() throws PersonException {
		...
		// Throws a person exception if the date of birth given is more than a hundred
		// years older than the current date
		if (age >= 100) {
	...
	//Throws a person exception if the phone number is not formatted correctly
	public void PrintPhone() throws PersonException {
